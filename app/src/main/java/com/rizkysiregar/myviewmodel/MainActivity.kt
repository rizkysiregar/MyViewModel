package com.rizkysiregar.myviewmodel

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.activity.viewModels
import androidx.lifecycle.ViewModelProvider
import com.rizkysiregar.myviewmodel.databinding.ActivityMainBinding
...
//        viewModel = ViewModelProvider(this).get(MainViewModel::class.java)
        ...
        activityMainBinding.btnCalculate.setOnClickListener {
            ...
            when {
                ...
                height.isEmpty() -> {
                    activityMainBinding.edtHeight.error = "Mashih Kosong"
                }
                length.isEmpty() -> {
